          ...
          <div className="space-y-12 relative">
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-indigo-600">Discovery</h3>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0 text-left md:text-right">
                <h3 className="text-2xl font-bold mb-3 text-indigo-600">Strategy</h3>
                <p className="text-gray-600">
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-indigo-600">Creation</h3>
                <p className="text-gray-600">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0 text-left md:text-right">
                <h3 className="text-2xl font-bold mb-3 text-indigo-600">Implementation</h3>
                <p className="text-gray-600">
              ...
              <div className="md:w-1/2 md:pr-12">
                <img src="https://cdn.jsdelivr.net/gh/Microsoft/fluentui-system-icons/assets/Arrow/SVG/ic_fluent_arrow_right_24_filled.svg" alt="Implementation Phase" className="w-40 h-40 mx-auto" />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-indigo-600">Analysis & Optimization</h3>
                <p className="text-gray-600">
              ...
              <div className="md:w-1/2 md:pl-12">
                <img src="https://cdn.jsdelivr.net/gh/Microsoft/fluentui-system-icons/assets/Data/SVG/ic_fluent_data_histogram_24_filled.svg" alt="Analysis Phase" className="w-40 h-40 mx-auto" />
              </div>
            </div>
          </div>
        </div>
