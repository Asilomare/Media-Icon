          ...
          <div className="space-y-12 relative">
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-primary">Discovery</h3>
              ...
              <div className="md:w-12 md:flex justify-center hidden">
                <div className="w-12 h-12 rounded-full icon-primary text-white flex items-center justify-center font-bold text-xl z-10">1</div>
              </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0 text-left md:text-right">
                <h3 className="text-2xl font-bold mb-3 text-primary">Strategy</h3>
                <p className="text-gray-600">
                  We develop a tailored marketing strategy that aligns with your goals and resonates with your target audience.
                </p>
              </div>
              <div className="md:w-12 md:flex justify-center hidden">
                <div className="w-12 h-12 rounded-full icon-primary text-white flex items-center justify-center font-bold text-xl z-10">2</div>
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-primary">Creation</h3>
                <p className="text-gray-600">
                  Our creative team brings the strategy to life through compelling content, design, and campaigns.
                </p>
              </div>
              <div className="md:w-12 md:flex justify-center hidden">
                <div className="w-12 h-12 rounded-full icon-primary text-white flex items-center justify-center font-bold text-xl z-10">3</div>
              </div>
              <div className="md:w-1/2 md:pl-12">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pl-12 mb-6 md:mb-0 text-left md:text-right">
                <h3 className="text-2xl font-bold mb-3 text-primary">Implementation</h3>
                <p className="text-gray-600">
                  We execute the strategy across all relevant channels, ensuring consistent messaging and branding.
                </p>
              </div>
              <div className="md:w-12 md:flex justify-center hidden">
                <div className="w-12 h-12 rounded-full icon-primary text-white flex items-center justify-center font-bold text-xl z-10">4</div>
              </div>
              <div className="md:w-1/2 md:pr-12">
            ...
            <div className="flex flex-col md:flex-row items-center" data-aos="fade-up">
              <div className="md:w-1/2 md:pr-12 mb-6 md:mb-0 text-right md:text-left">
                <h3 className="text-2xl font-bold mb-3 text-primary">Analysis & Optimization</h3>
                <p className="text-gray-600">
                  We continuously monitor performance and make data-driven adjustments to maximize results.
                </p>
              </div>
              <div className="md:w-12 md:flex justify-center hidden">
                <div className="w-12 h-12 rounded-full icon-primary text-white flex items-center justify-center font-bold text-xl z-10">5</div>
              </div>
              <div className="md:w-1/2 md:pl-12">
